                                                                ...
                                                                iconData.map((icon, index) => {
                                                                    return (
                                                                        <li key={index} dangerouslySetInnerHTML={{ __html: icon.svg }} onClick={() => {
                                                                            dispatch(changeIconofMagicText({ id: item.id, svg: icon.svg, paths: icon.paths, viewbox: icon.viewbox, fill: icon.fill, type: icon.type, pathfill: icon.pathfill }));
                                                                            dispatch(changeIcon({ nodeid: item.id, svg: icon.svg, paths: JSON.stringify(icon.paths), viewbox: icon.viewbox, fill: icon.fill, type: icon.type, pathfill: icon.pathfill }));
                                                                            setOpenId(null);
                                                                        }}></li>
                                                                    )
                                                                })
