...
const StudioSidebar = ({ value, onChange }) => {
    return (
        <aside className={styles.sidebarWrapper}>
            <div className={styles.sidebarContent}>
                <button className={`${styles.sidebarButton} ${value === 'text' ? `${styles.active}` : ''}`} onClick={() => onChange("text")}>
                    <i>
                ...
                <button className={`${styles.sidebarButton} ${value === 'images' ? `${styles.active}` : ''}`} onClick={() => onChange("images")}>
                    <i>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                ...
                <button className={`${styles.sidebarButton} ${value === 'shapes' ? `${styles.active}` : ''}`} onClick={() => onChange("shapes")}>
                    <i>
                ...
                <button className={`${styles.sidebarButton} ${value === 'magictext' ? `${styles.active}` : ''}`} onClick={() => onChange("magictext")}>
                    <i>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span>Magic Text</span>
                </button>
                <button className={`${styles.sidebarButton} ${value === 'background' ? `${styles.active}` : ''}`} onClick={() => onChange("background")}>
                    <i>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <button className={`${styles.sidebarButton} ${value === 'qrcodes' ? `${styles.active}` : ''}`} onClick={() => onChange("qrcodes")}>
                    <i>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
